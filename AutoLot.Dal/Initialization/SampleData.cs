...
public static class SampleData
{
    ...
    {
        new() { Id = 1, CustomerId = Customers[4].Id, PersonInformation =
            new() { FirstName = Customers[4].PersonInformation.FirstName, LastName = Customers[4].PersonInformation.FirstName } }
    };
}
