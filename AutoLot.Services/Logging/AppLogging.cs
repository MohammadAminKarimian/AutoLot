...
public class AppLogging<T> : IAppLogging<T>
{
    ...
    internal static void LogWithException(string memberName, string sourceFilePath, int sourceLineNumber,
        Exception ex, string message, Action<Exception, string, object[]> logAction)
    {
    ...
    internal static void LogWithoutException(string memberName, string sourceFilePath, int sourceLineNumber,
    ...
    public void LogAppCritical(Exception exception, string message, [CallerMemberName] string memberName = "", [CallerFilePath] string sourceFilePath = "", [CallerLineNumber] int sourceLineNumber = 0)
    {
